      ...
      <nav class="mt-2">
        <ul class="nav flex-column">
            <li class="nav-item mb-3">
                ...
                <span><img src="{{ asset('svg/dashboard-violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">Dashboard</span>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link text-dark" href="/tickets">
                <span><img src="{{ asset('svg/ticketing-violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">Tickets</span>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link text-dark" href="/personal">
                <span><img src="{{ asset('svg/pnp-violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">PNP Personal</span>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link text-dark" href="station">
                <span><img src="{{ asset('svg/station-violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">Station list</span>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link text-dark" href="/category">
                <span><img src="{{ asset('svg/category-violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">Category list</span>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link text-dark" href="/violation">
                <span><img src="{{ asset('svg/violation - violet.svg') }}" style="width: 25px" alt="Kiwi standing on oval"></span>
                <span class="font-weight-bold ml-1" style="font-size: 17px">Violation list</span>
                </a>
            </li>
        </ul>
      </nav>
